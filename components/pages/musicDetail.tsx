...
export default function MusicDetail({ id }: { id: string }) {
        ...
        return (
            <div className="min-h-screen bg-background flex items-center justify-center px-4">
                <div className="text-center">
                    ...
                    <Button onClick={() => router.push("/music")} className="rounded-xl">Kembali ke Beranda</Button>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-background text-foreground">
            <header className="border-b border-border bg-white dark:bg-card">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <Button onClick={() => router.push("/music")} variant="ghost" className="flex items-center gap-2 text-muted-foreground hover:text-foreground">
                        <ArrowLeft size={20} />
                        Kembali ke Artis
                    </Button>
                </div>
