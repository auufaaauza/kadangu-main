...
const MascotBanner = () => {
  ...
  return (
    <motion.div
      ...
      className="relative bg-teal-600 rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6 my-8 sm:my-12 overflow-hidden"
    >
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
        ...
        >
          <Button
            ...
            size="lg"
            className="bg-teal-500 text-white hover:bg-transparent border border-teal-500 font-bold group rounded-full text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3"
          >
            Mulai
