...
import { THEATER_TALENTS, THEATER_CATEGORIES } from "@/data/theaterData";
...
export default function TheaterPage() {
    ...
    const filteredTalents = selectedCategory
        ? THEATER_TALENTS.filter((t) => t.category === selectedCategory)
        : THEATER_TALENTS;
            ...
            <section className="bg-gradient-to-br from-teal-600 to-teal-700 text-white py-20 px-4">
                <div className="container mx-auto text-center">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
                        Talenta Teater Profesional
                    </h1>
                    <p className="text-lg md:text-xl text-teal-50 max-w-3xl mx-auto">
                        Booking grup teater dan aktor profesional untuk pertunjukan Anda
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="mb-12 text-center">
                        <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
                            Grup Teater Unggulan
                        </h2>
                        <p className="text-lg text-gray-600 mb-8">
                            Pilih dari koleksi grup teater terbaik kami
                        </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredTalents.map((talent) => (
                            <TalentCard key={talent.id} talent={talent} type="theater" />
                        ))}
                    </div>
                </div>
            </section>
