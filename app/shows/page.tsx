...
import { SHOWS_EVENTS, SHOWS_CATEGORIES } from "@/data/showsData";
...
export default function ShowsPage() {
    ...
    const filteredEvents = selectedCategory
        ? SHOWS_EVENTS.filter((e) => e.category === selectedCategory)
        : SHOWS_EVENTS;
            ...
            <section className="bg-gradient-to-br from-teal-600 to-teal-700 text-white py-20 px-4">
                <div className="container mx-auto text-center">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
                        Pertunjukan & Event Seni
                    </h1>
                    <p className="text-lg md:text-xl text-teal-50 max-w-3xl mx-auto">
                        Dapatkan tiket untuk pertunjukan musik, tari, teater, dan seni lainnya
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="mb-12 text-center">
                        ...
                        <p className="text-lg text-gray-600 mb-8">
                            Pilih event yang ingin Anda hadiri
                        </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredEvents.map((event) => (
                            <EventCard key={event.id} event={event} type="show" />
                        ))}
                    </div>
                </div>
            </section>
            ...
            <section className="bg-teal-600 text-white py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto text-center">
                    <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                        Jangan Lewatkan Event Favorit Anda!
                    </h2>
                    <p className="text-lg mb-8 text-teal-50">
                        Dapatkan tiket sekarang sebelum kehabisan
                    </p>
                    <Button
                        size="lg"
