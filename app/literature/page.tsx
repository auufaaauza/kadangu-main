...
import { LITERATURE_TALENTS, LITERATURE_CATEGORIES } from "@/data/literatureData";
...
export default function LiteraturePage() {
    ...
    const filteredTalents = selectedCategory
        ? LITERATURE_TALENTS.filter((t) => t.category === selectedCategory)
        : LITERATURE_TALENTS;
            ...
            <section className="bg-gradient-to-br from-teal-600 to-teal-700 text-white py-20 px-4">
                <div className="container mx-auto text-center">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
                        Penulis & Sastrawan Terbaik
                    </h1>
                    <p className="text-lg md:text-xl text-teal-50 max-w-3xl mx-auto">
                        Booking penulis, penyair, dan sastrawan untuk acara literasi Anda
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="mb-12 text-center">
                        ...
                        <p className="text-lg text-gray-600 mb-8">
                            Pilih dari koleksi penulis dan sastrawan terbaik kami
                        </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredTalents.map((talent) => (
                            <TalentCard key={talent.id} talent={talent} type="literature" />
                        ))}
                    </div>
                </div>
            </section>
