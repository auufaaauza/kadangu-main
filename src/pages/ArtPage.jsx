...
export function ArtPage() {
  ...
  const filteredArtists = selectedCategory
    ? ART_ARTISTS.filter((a) => a.category === selectedCategory)
    : ART_ARTISTS;
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-heading font-bold text-foreground mb-4 leading-tight">
            ...
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">
              Seniman Seni Rupa Terbaik
            </span>
          </h1>

          <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Platform digital terpercaya untuk menemukan dan memesan seniman seni rupa profesional. 
            Dari lukisan hingga seni digital, kami punya semua yang Anda butuhkan.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg">Jelajahi Seniman</Button>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Seniman Tersedia</p>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-heading font-bold text-accent mb-2">300+</div>
              <p className="text-muted-foreground">Karya Selesai</p>
            </div>
            <div className="text-center col-span-2 md:col-span-1">
              <div className="text-3xl sm:text-4xl font-heading font-bold text-secondary mb-2">97%</div>
      ...
      <section id="artists" className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="mb-12 text-center">
            <h2 className="text-3xl sm:text-4xl font-heading font-bold text-foreground mb-4">Seniman Seni Rupa Unggulan</h2>
            <p className="text-lg text-muted-foreground mb-8">Pilih dari koleksi seniman seni rupa terbaik kami</p>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              {categories.map((cat) => (
                ...
                >
                  {cat === "painting" ? "Lukisan" : cat === "sculpture" ? "Patung" : "Digital"}
                </Button>
              ))}
            </div>
          </div>
