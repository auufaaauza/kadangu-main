...
import { Heart, Users, MapPin, Play, Timer } from "lucide-react";
import { cn } from "@/lib/utils";
import { Button } from "@/components/ui/button";
import { CategoryBadge } from "@/components/dance/CategoryBadge";

export function DanceCard({ dance }) {
        ...
        <div className="flex-1 p-4 flex flex-col">
          ...
          <div className="space-y-2 mb-4 text-sm text-muted-foreground">
            <div className="flex items-center gap-2">
              <Users size={16} />
              <span>{dance.members} Penari</span>
            </div>
          ...
          {/* BUTTON */}
<RouterLink to={`/dance/detail/${dance.id}`} className="mt-auto">
